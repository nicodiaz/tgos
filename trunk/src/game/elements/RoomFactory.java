...
public class RoomFactory
{
	...
	/*
	 * TODO: Make a parameter in the constructor to generate a random room.
	 * 
	 */
...
//		final Box frontWallBox = new Box("frontWall", new Vector3f(0, 0, -FAR), SIZEFACTOR, SIZEFACTOR, ESPESOR);
//		room.attachChild(frontWallBox);
//
//		// The floor
//		final Box floorBox = new Box("floor", new Vector3f(0, -SIZEFACTOR, 0), SIZEFACTOR, ESPESOR, FAR);
//		room.attachChild(floorBox);
//
//		// The roof
//		final Box roofBox = new Box("roof", new Vector3f(0, SIZEFACTOR, 0), SIZEFACTOR, ESPESOR, FAR);
//		room.attachChild(roofBox);
//		
//		// The right wall
//		final Box rightWallBox = new Box("rightWall", new Vector3f(SIZEFACTOR, 0, 0), ESPESOR, SIZEFACTOR, FAR);
//		room.attachChild(rightWallBox);
//		
//		// The left wall
//		final Box leftWallBox = new Box("leftWall", new Vector3f(-SIZEFACTOR, 0, 0), ESPESOR, SIZEFACTOR, FAR);
