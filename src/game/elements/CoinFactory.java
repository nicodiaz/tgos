...
public class CoinFactory extends SapoElement
{
	 ...
	 * @param rootNode
	 */
	public CoinFactory(PhysicsSpace theSpace, Node rootNode, DisplaySystem disp)
	{
...
//
//		coinDynamicNode.getLocalTranslation().set(new Vector3f());
...
//		coinDynamicNode.computeMass();
	...
	public CoinFactory(PhysicsSpace theSpace, Node rootNode, DisplaySystem disp, Vector3f origin)
	{
	...
	{
		return (new Coin(this.space, this.rootNode, this.display));
	}
