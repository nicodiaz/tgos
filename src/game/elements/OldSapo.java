 ...
 *
 */
public class OldSapo
{
	private StaticPhysicsNode sapoStaticNode = null;

	public OldSapo(PhysicsSpace theSpace, Node rootNode)
	{
...
//		sapoStaticNode.updateModelBound();
	...
	public OldSapo(PhysicsSpace theSpace, Node rootNode, Vector3f center)
	{
